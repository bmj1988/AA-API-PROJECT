    ...
    return (
        <div className={submitted ? 'hidden' : ''}>
            <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <textarea rows='8' className="textmark reviewTexta" minLength={10} maxLength={500} placeholder="Leave your review here" autoFocus onChange={(e) => setReview(e.target.value)} />
